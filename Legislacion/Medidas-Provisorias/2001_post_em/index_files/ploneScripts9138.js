...
/* - fckeditor.js - */
// http://www4.planalto.gov.br/legislacao/portal_javascripts/fckeditor.js?original=1
...
/* - fck_plone.js - */
// http://www4.planalto.gov.br/legislacao/portal_javascripts/fck_plone.js?original=1
var FCKBaseHref={};makeLinksRelative=function(basehref,contents){var base=basehref.replace('http://www4.planalto.gov.br','');var href=base.replace(/\/[^\/]*$/,'/');var hrefparts=href.split('/');return contents.replace(/(<[^>]* (?:src|href)=")([^"]*)"/g,
function(str,tag,url,offset,contents){url=url.replace('http://www4.planalto.gov.br','');if(url.substring(0,1)=='#'){str=tag+url+'"'}
...
/* - fck_ploneInit.js - */
// http://www4.planalto.gov.br/legislacao/portal_javascripts/fck_ploneInit.js?original=1
