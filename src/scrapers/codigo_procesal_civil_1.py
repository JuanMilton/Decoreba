...
def procesarLegislacion(soup):
	try:
		...
		ley_id = dao.segmentoDAO.insert('<p align="left"><font face="Arial" color="#800000" size="2">Institui o Código de Processo Civil.</font></p>', dao.segmentoDAO.TIPO_LEY, None, None, 'L5869')
